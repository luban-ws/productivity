...
const __pageData = JSON.parse('{"title":"RFCs (Request for Comments)","description":"","frontmatter":{},"headers":[],"relativePath":"rfc/README.md","filePath":"rfc/README.md"}');
const _sfc_main = { name: "rfc/README.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("rfc/README.md");
